#!/usr/bin/env python3
"""Measure attribution accuracy on the trusted-29 corpus from current DB state.

For each rally_action_ground_truth row across the 29 trusted videos:
...
Usage:
    ...
    uv run python scripts/measure_attribution_trusted_29_2026_05_17.py --label scorer_on --compare-to scorer_off
"""
...
OUT_DIR = Path("reports/attribution_trusted_29_2026_05_17")
...
def measure() -> dict:
    ...
    return {
        ...
        "by_video_action": {
            ...
            for v in TRUSTED_29 for a in ACTION_TYPES
