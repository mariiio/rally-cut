...
def test_build_label_row_returns_none_on_malformed() -> None:
    assert build_label_row({"action": "serve"}, None, None, None, None) is None  # no frame
    assert build_label_row({"frame": 0, "action": "bogus"}, None, None, None, None) is None  # invalid action
