...
from rallycut.cli.commands.evaluate_tracking import evaluate_tracking as evaluate_tracking_command
...
app.command(name="evaluate-tracking")(evaluate_tracking_command)
