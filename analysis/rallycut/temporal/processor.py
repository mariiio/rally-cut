...
.. deprecated::
    ...
    Deterministic Decoder pipeline instead, which achieves 84% F1
...
class TemporalProcessor:
    ...
    .. deprecated::
        ...
        The binary head pipeline achieves 84% F1 with 0% overmerge rate.
    ...
    def __init__(self, config: TemporalProcessorConfig | None = None):
        ...
        warnings.warn(
            ...
            "instead (84% F1 vs 65% F1). The new default pipeline auto-selects binary"
